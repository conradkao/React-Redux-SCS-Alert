...
var trackBlur = function (ToMix) {
  var TrackBlur = function (_ToMix) {
    ...
    function TrackBlur(element, options) {
      _classCallCheck$12(this, TrackBlur);

      var _this = _possibleConstructorReturn$11(this, (TrackBlur.__proto__ || Object.getPrototypeOf(TrackBlur)).call(this, element, options));
    ...
    _createClass$11(TrackBlur, [{
      ...
      value: function release() {
        ...
        _get$3(TrackBlur.prototype.__proto__ || Object.getPrototypeOf(TrackBlur.prototype), 'release', this).call(this);
      }
    }]);
...
var initComponentByLauncher = function (ToMix) {
  ...
  var InitComponentByLauncher = function (_ToMix) {
    _inherits$13(InitComponentByLauncher, _ToMix);

    function InitComponentByLauncher() {
      _classCallCheck$14(this, InitComponentByLauncher);

      return _possibleConstructorReturn$13(this, (InitComponentByLauncher.__proto__ || Object.getPrototypeOf(InitComponentByLauncher)).apply(this, arguments));
    }

    _createClass$13(InitComponentByLauncher, null, [{
      key: 'init',
...
var Modal = function (_mixin) {
  ...
  function Modal(element, options) {
    _classCallCheck$13(this, Modal);

    var _this = _possibleConstructorReturn$12(this, (Modal.__proto__ || Object.getPrototypeOf(Modal)).call(this, element, options));
  ...
  _createClass$12(Modal, [{
    ...
    value: function release() {
      ...
      _get$4(Modal.prototype.__proto__ || Object.getPrototypeOf(Modal.prototype), 'release', this).call(this);
    }
...
var Loading = function (_mixin) {
  ...
  function Loading(element, options) {
    _classCallCheck$15(this, Loading);

    var _this = _possibleConstructorReturn$14(this, (Loading.__proto__ || Object.getPrototypeOf(Loading)).call(this, element, options));
...
var Dropdown = function (_mixin) {
  ...
  function Dropdown(element, options) {
    _classCallCheck$16(this, Dropdown);

    /**
     * The handle to release click event listener on document object.
     * @member {Handle}
     */
    var _this = _possibleConstructorReturn$15(this, (Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call(this, element, options));
  ...
  _createClass$15(Dropdown, [{
    ...
    value: function release() {
      ...
      _get$5(Dropdown.prototype.__proto__ || Object.getPrototypeOf(Dropdown.prototype), 'release', this).call(this);
    }
...
var Card = function (_mixin) {
  ...
  function Card(element, options) {
    _classCallCheck$17(this, Card);

    var _this = _possibleConstructorReturn$16(this, (Card.__proto__ || Object.getPrototypeOf(Card)).call(this, element, options));
...
var NumberInput = function (_mixin) {
  _inherits$17(NumberInput, _mixin);
  ...
  function NumberInput(element, options) {
    _classCallCheck$18(this, NumberInput);
    ...
    var _this = _possibleConstructorReturn$17(this, (NumberInput.__proto__ || Object.getPrototypeOf(NumberInput)).call(this, element, options));
...
var DataTable = function (_mixin) {
  ...
  function DataTable(element, options) {
    _classCallCheck$19(this, DataTable);

    var _this = _possibleConstructorReturn$18(this, (DataTable.__proto__ || Object.getPrototypeOf(DataTable)).call(this, element, options));
...
flatpickr_1.l10ns.en.weekdays.shorthand.forEach(function (day, index) {
  var currentDay = flatpickr_1.l10ns.en.weekdays.shorthand;
...
var DatePicker = function (_mixin) {
  _inherits$19(DatePicker, _mixin);
  ...
  function DatePicker(element, options) {
    _classCallCheck$20(this, DatePicker);

    var _this = _possibleConstructorReturn$19(this, (DatePicker.__proto__ || Object.getPrototypeOf(DatePicker)).call(this, element, options));
  ...
  _createClass$19(DatePicker, [{
    ...
    value: function release() {
      ...
      return _get$6(DatePicker.prototype.__proto__ || Object.getPrototypeOf(DatePicker.prototype), 'release', this).call(this);
    }
...
var _initialiseProps$1 = function _initialiseProps() {
  ...
  this._initDatePicker = function (type) {
    ...
    var calendar = new flatpickr_1(date, Object.assign(flattenOptions(_this2.options), {
      allowInput: true,
      mode: type,
  ...
  this._updateClassNames = function (calendar) {
    ...
    [].concat(_toConsumableArray$10(calendarContainer.querySelectorAll('.flatpickr-weekday'))).forEach(function (item) {
      var currentItem = item;
      currentItem.innerHTML = currentItem.innerHTML.replace(/\s+/g, '');
      currentItem.classList.add(_this2.options.classWeekday);
    });
    [].concat(_toConsumableArray$10(calendarContainer.querySelectorAll('.flatpickr-day'))).forEach(function (item) {
...
var DetailPageHeader = function (_mixin) {
  _inherits$20(DetailPageHeader, _mixin);
  ...
  function DetailPageHeader(element, options) {
    _classCallCheck$21(this, DetailPageHeader);

    var _this = _possibleConstructorReturn$20(this, (DetailPageHeader.__proto__ || Object.getPrototypeOf(DetailPageHeader)).call(this, element, options));
  ...
  _createClass$20(DetailPageHeader, [{
    key: '_handleScroll',
    ...
    value: function release() {
      ...
      _get$7(DetailPageHeader.prototype.__proto__ || Object.getPrototypeOf(DetailPageHeader.prototype), 'release', this).call(this);
    }
...
var LeftNav = function (_mixin) {
  ...
  function LeftNav(element, options) {
    _classCallCheck$22(this, LeftNav);

    var _this = _possibleConstructorReturn$21(this, (LeftNav.__proto__ || Object.getPrototypeOf(LeftNav)).call(this, element, options));
  ...
  _createClass$21(LeftNav, [{
    ...
    value: function animateNavList(selectedNavTitle) {
      ...
      var currentLeftNavItems = [].concat(_toConsumableArray$11(currentLeftNavList.querySelectorAll(this.options.selectorLeftNavListItem))).reverse();
      var newLeftNavItems = [].concat(_toConsumableArray$11(newLeftNavList.querySelectorAll(this.options.selectorLeftNavListItem)));
    ...
    value: function hookListItemsEvents() {
      ...
      var leftNavList = [].concat(_toConsumableArray$11(this.element.querySelectorAll(this.options.selectorLeftNavList)));
      ...
      var flyouts = [].concat(_toConsumableArray$11(this.element.ownerDocument.querySelectorAll(this.options.selectorLeftNavListItemHasFlyout)));
    ...
    value: function hideAllFlyoutMenus() {
      ...
      var flyoutMenus = [].concat(_toConsumableArray$11(this.element.querySelectorAll(this.options.selectorLeftNavFlyoutMenu)));
    ...
    value: function addActiveListItem(item) {
      ...
      [].concat(_toConsumableArray$11(this.element.querySelectorAll(this.options.selectorLeftNavAllListItems))).forEach(function (currentItem) {
        if (!(item === currentItem)) {
    ...
    value: function handleNestedListClick(listItem) {
      ...
      var listItems = [].concat(_toConsumableArray$11(listItem.querySelectorAll(this.options.selectorLeftNavNestedListItem)));
    ...
    value: function release() {
      ...
      _get$8(LeftNav.prototype.__proto__ || Object.getPrototypeOf(LeftNav.prototype), 'release', this).call(this);
    }
...
var InteriorLeftNav = function (_mixin) {
  _inherits$22(InteriorLeftNav, _mixin);
  ...
  function InteriorLeftNav(element, options) {
    _classCallCheck$23(this, InteriorLeftNav);

    var _this = _possibleConstructorReturn$22(this, (InteriorLeftNav.__proto__ || Object.getPrototypeOf(InteriorLeftNav)).call(this, element, options));
  ...
  _createClass$22(InteriorLeftNav, [{
    key: 'addActiveListItem',
    value: function addActiveListItem(item) {
      var _this2 = this;

      [].concat(_toConsumableArray$12(this.element.querySelectorAll(this.options.selectorLeftNavListItem))).forEach(function (currentItem) {
        if (!(item === currentItem)) {
          currentItem.classList.remove(_this2.options.classActiveLeftNavListItem);
        }
      });
      [].concat(_toConsumableArray$12(this.element.querySelectorAll(this.options.selectorLeftNavNestedListItem))).forEach(function (currentItem) {
        if (!(item === currentItem)) {
          currentItem.classList.remove(_this2.options.classActiveLeftNavListItem);
        }
      });
    ...
    value: function handleNestedListClick(listItem, evt) {
      ...
      var allNestedItems = [].concat(_toConsumableArray$12(document.querySelectorAll(this.options.selectorLeftNavListItemHasChildren)));
      var isOpen = listItem.classList.contains(this.options.classExpandedLeftNavListItem);
      ...
      var listItems = [].concat(_toConsumableArray$12(list.querySelectorAll(this.options.selectorLeftNavNestedListItem)));
      listItems.forEach(function (item) {
        if (isOpen) {
          // eslint-disable-next-line no-param-reassign
...
var ProfileSwitcher = function (_mixin) {
  _inherits$23(ProfileSwitcher, _mixin);
  ...
  function ProfileSwitcher(element, options) {
    _classCallCheck$24(this, ProfileSwitcher);

    var _this = _possibleConstructorReturn$23(this, (ProfileSwitcher.__proto__ || Object.getPrototypeOf(ProfileSwitcher)).call(this, element, options));
  ...
  _createClass$23(ProfileSwitcher, [{
    key: 'toggle',
    value: function toggle(event) {
      var isOfSelf = this.element.contains(event.target);
    ...
    value: function release() {
      ...
      _get$9(ProfileSwitcher.prototype.__proto__ || Object.getPrototypeOf(ProfileSwitcher.prototype), 'release', this).call(this);
    }
...
var Pagination = function (_mixin) {
  _inherits$24(Pagination, _mixin);
  ...
  */
  function Pagination(element, options) {
    _classCallCheck$25(this, Pagination);

    var _this = _possibleConstructorReturn$24(this, (Pagination.__proto__ || Object.getPrototypeOf(Pagination)).call(this, element, options));
...
var Search = function (_mixin) {
  ...
  function Search(element, options) {
    _classCallCheck$26(this, Search);

    var _this = _possibleConstructorReturn$25(this, (Search.__proto__ || Object.getPrototypeOf(Search)).call(this, element, options));
  ...
  _createClass$24(Search, [{
    key: 'toggleLayout',
    value: function toggleLayout(element) {
      var _this2 = this;

      [].concat(_toConsumableArray$13(element.querySelectorAll(this.options.selectorSearchView))).forEach(function (item) {
...
var Accordion = function (_mixin) {
  ...
  function Accordion(element, options) {
    _classCallCheck$27(this, Accordion);

    var _this = _possibleConstructorReturn$26(this, (Accordion.__proto__ || Object.getPrototypeOf(Accordion)).call(this, element, options));
...
var CopyButton = function (_mixin) {
  _inherits$27(CopyButton, _mixin);
  ...
  function CopyButton(element, options) {
    _classCallCheck$28(this, CopyButton);

    var _this = _possibleConstructorReturn$27(this, (CopyButton.__proto__ || Object.getPrototypeOf(CopyButton)).call(this, element, options));
...
var Notification = function (_mixin) {
  _inherits$28(Notification, _mixin);
  ...
  function Notification(element, options) {
    _classCallCheck$29(this, Notification);

    var _this = _possibleConstructorReturn$28(this, (Notification.__proto__ || Object.getPrototypeOf(Notification)).call(this, element, options));
...
var Toolbar = function (_mixin) {
  ...
  function Toolbar(element, options) {
    _classCallCheck$30(this, Toolbar);

    var _this = _possibleConstructorReturn$29(this, (Toolbar.__proto__ || Object.getPrototypeOf(Toolbar)).call(this, element, options));
  ...
  _createClass$28(Toolbar, [{
    ...
    value: function _handleDocumentClick(event) {
      ...
      [].concat(_toConsumableArray$14(this.element.ownerDocument.querySelectorAll(this.options.selectorSearch))).forEach(function (item) {
    ...
    value: function release() {
      ...
      _get$10(Toolbar.prototype.__proto__ || Object.getPrototypeOf(Toolbar.prototype), 'release', this).call(this);
    }
...
var Tooltip = function (_mixin) {
  ...
  function Tooltip(element, options) {
    _classCallCheck$31(this, Tooltip);

    var _this = _possibleConstructorReturn$30(this, (Tooltip.__proto__ || Object.getPrototypeOf(Tooltip)).call(this, element, options));
...
var ProgressIndicator = function (_mixin) {
  _inherits$31(ProgressIndicator, _mixin);
  ...
  function ProgressIndicator(element, options) {
    _classCallCheck$32(this, ProgressIndicator);

    var _this = _possibleConstructorReturn$31(this, (ProgressIndicator.__proto__ || Object.getPrototypeOf(ProgressIndicator)).call(this, element, options));
  ...
  _createClass$30(ProgressIndicator, [{
    key: 'getSteps',
    value: function getSteps() {
      return [].concat(_toConsumableArray$15(this.element.querySelectorAll(this.options.selectorStepElement))).map(function (element, index) {
        return {
          element: element,
          index: index
        };
...
var StructuredList = function (_mixin) {
  _inherits$32(StructuredList, _mixin);
  ...
  function StructuredList(element, options) {
    _classCallCheck$33(this, StructuredList);

    var _this = _possibleConstructorReturn$32(this, (StructuredList.__proto__ || Object.getPrototypeOf(StructuredList)).call(this, element, options));
  ...
  _createClass$31(StructuredList, [{
    key: '_direction',
    ...
    value: function _getInput(index) {
      var rows = [].concat(_toConsumableArray$16(this.element.querySelectorAll(this.options.selectorRow)));
    ...
    value: function _handleClick(evt) {
      ...
      [].concat(_toConsumableArray$16(this.element.querySelectorAll(this.options.selectorRow))).forEach(function (row) {
...
var Slider = function (_mixin) {
  ...
  function Slider(element, options) {
    _classCallCheck$34(this, Slider);

    var _this = _possibleConstructorReturn$33(this, (Slider.__proto__ || Object.getPrototypeOf(Slider)).call(this, element, options));
  ...
  _createClass$32(Slider, [{
    ...
    value: function release() {
      ...
      _get$11(Slider.prototype.__proto__ || Object.getPrototypeOf(Slider.prototype), 'release', this).call(this);
    }
